CREATE TABLE IF NOT EXISTS "zcos_file_artifacts" (
    "id" TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS "zcos_file_artifacts_owner_user_id_created_at_idx"
ON "zcos_file_artifacts"("owner_user_id", "created_at");

CREATE INDEX IF NOT EXISTS "zcos_file_artifacts_owner_user_id_content_hash_idx"
