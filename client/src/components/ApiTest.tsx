    ...
    <div className="p-4 bg-gray-900 text-white rounded-lg">
      ...
      <div className="space-y-4">
        <div>
          ...
          {healthError && <p className="text-red-400">Error: {healthError.message}</p>}
          {healthData && (
        ...
        <div>
          ...
          {statusError && <p className="text-red-400">Error: {statusError.message}</p>}
          {statusData && (
            <div className="text-green-400">
              ✅ Connected - {Array.isArray(statusData) ? statusData.length : 'Unknown'} status entries
            </div>
          )}
        </div>
      </div>
